...
private let kAppGroupIdentifier = "group.com.<YOUR_DOMAIN>.souschef.documents"
private let kInitialRecipesCopiedKey = "com.rw.souschef.recipesCopied"
private let kRemoteRecipesURLString = "https://raw.githubusercontent.com/raywenderlich/recipes/master/Recipes.json"
public class RecipeStore {

  public init() {
    // 1.
    if let sharedUserDefaults =
      NSUserDefaults(suiteName: kAppGroupIdentifier) {
        ...
        NSBundle(forClass: RecipeStore.self).URLForResource(kRecipesFileName, withExtension:
