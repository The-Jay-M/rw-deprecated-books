...
public struct GroceryListConfig {
  ...
  public static let groupID = "group.com.rw.souschef.documents"
  public static let iCloudID = "iCloud.com.rw.SousChef"
...
//  }()
  ...
  private func saveCurrentState() {
    saveToURL(fileURL, forSaveOperation: UIDocumentSaveOperation.ForOverwriting, completionHandler: { success in
      if success {
