...
-(void)loadAnimations {
    ...
    jumpUpAnim = [self loadAnimationFromPlist:@"jumpUpAnim" 
      forClass:@"MeanCrawler"];
    dyingAnim = [self loadAnimationFromPlist:@"dyingAnim" forClass:@"MeanCrawler"];
}
...
-(void)changeState:(CharacterStates)newState {
    ...
    switch (newState) {
        ...
        case kStateDead:
            ...
            action = [CCSequence actions:[CCAnimate actionWithAnimation:dyingAnim],
            [CCCallFunc actionWithTarget:self selector:@selector(removeSelf)], nil ];
            break;            
        default:
            break;
    }
